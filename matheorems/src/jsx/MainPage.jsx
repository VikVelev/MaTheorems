...
export default class MainPage extends Component {
    ...
    state = { activeTheorem: "", activeClassItem: "", classClicked: false, classNumber: 99999999 }

    handleTheoremClick = (e, { name }) => {
        
        this.setState({ activeTheorem: name });
    }
                ...
                <div className="main-item left">
                    ...
                    <div>
                        ...
                        <Menu vertical>
                            ...
                            {this.data.map((object, i) => this.theoremItem(object,i)) }
                        </Menu> 
                    </div>
                    : null }
                </div>
