...
export default class MainPage extends Component {
    ...
    data = {
        id: 0,
        name: "LOL",
        description: "description123123123123213213",
        data: "whatwhat",
    }
    ...
    classItem(id, i) {
        return(
            <Menu.Item
                ...
                id={id}
                key={i}
                active={this.state.activeClassItem === id}
    ...
    theoremItem(data, classNumber, i){
        return(
            <Menu.Item
                className="theorem"
                name={toString(data.id)}
                key={i}
                active={this.state.activeItem === data.id}
        ...
        return(
            <div className="main-container">
                <div className="main-item left">
                    ...
                    { this.state.classClicked ? 
                    <Menu vertical>
                        {/* array.map here when integrating */}
                        {this.theoremItem(this.data, this.state.classNumber)}
                    </Menu> : null }
                </div>
